...
EXEC_S = executer.c built_in_ft.c pipex.c status.c execut_utils.c dup_pipex.c
EXEC_D = executer/

PARSER_S = parser.c parser_utils.c parser_is_who.c\
			parser_exec_data_creat.c parser_exec_data_utils.c parser_proc_redirect.c\
...
SOURCES_S =  minish.c \
			...
			heredoc.c ft_atol.c ft_error.c var_dllr_utils.c
